      ...
      <div className="responsive-detail-header">
        ...
        <div className="metadata-container">
          ...
          {album?.spotify_album_id && (
            <a href={`https://open.spotify.com/album/${album.spotify_album_id}`} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'var(--spotify-color, #1DB954)', color: '#fff', textDecoration: 'none', fontWeight: 600, fontSize: '0.95rem', padding: '10px 16px', borderRadius: '20px', marginBottom: '16px', width: 'fit-content', boxShadow: '0 4px 12px rgba(29, 185, 84, 0.3)', transition: 'transform 0.2s, box-shadow 0.2s' /* allow-hardcoded-color */ }} onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 6px 16px rgba(29, 185, 84, 0.4)'; }} onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 12px rgba(29, 185, 84, 0.3)'; }}>
